...
import logging
from api import post_api,manual_evse_meter
...
class EVSEManager:
    ...
    def __init__(self):
        ...
        self.trigger_percent = 0.6
        self.release_percent = 0.4
        self.trigger_threshold = self.trigger_percent * self.site_capacity     # 0.60*20 = 12A
    ...
    def dlm_threshold(self, No_of_EVSEs_in_use):
        ...
        cp_change = False                                       # [Flag] To track Charging Profile change
    ...
    def perform_dlm(self, total_load_t, site_capacity, C_CP_t_minus_1):
        ...
        if total_load_t >= site_capacity:
            ...
            if total_load_t > site_capacity:
                ...
                print(f"EVSEs stopped charging as total load (t) hits maximum site capacity!")
