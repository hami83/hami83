...
class EVSEManager:
    ...
    def __init__(self):
        ...
        # THRESHOLDS FOR TRIGGERING DLM (TPN)
        ...
        # DATABASE & TABLE CREATION with constructed COLUMN DEFINITIONS (TPN)
        self.timeslots = 10
        self.phases = 3
        ...
        #     for n in range(1, self.phases+1):
        #         self.column_definitions.append(f"TIME_{i}_L{L} DECIMAL(10,5)")
        for i in range(1, self.timeslots+1):                            # Each row represents current per iteration
            self.column_definitions.append(f"TIME_{i}_L{L} DECIMAL(10,5)")
